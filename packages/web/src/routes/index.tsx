        ...
        {primaryValue?.status && primaryValue.status === 200 && primaryValue.data
          ? (
            <a href={primaryValue.data.subtitleShortLink} class="text-zinc-600 flex-1 p-2">
              <div>
                <p>
                  {primaryValue.data.Movies?.name}
                  {' '}
                  from
                  {primaryValue.data.Movies?.year}
                  {' '}
                  at
                  {primaryValue.data.resolution}
                </p>
              </div>
              <div>
                <p>
                  Release Group:
                  {primaryValue.data.ReleaseGroups?.name}
                </p>
                <p>
                  Subtitle Group:
                  {primaryValue.data.SubtitleGroups?.name}
                </p>
              </div>
            </a>
            )
