...
export function Header() {
  ...
  return (
    <header className="fixed z-50 top-0 left-0 right-0 mx-auto p-4 bg-zinc-950/90 backdrop-blur-md w-full h-16">
      <nav className="flex items-center justify-between w-full relative container mx-auto md:px-4">
