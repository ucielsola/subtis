  ...
  return (
    <Accordion onValueChange={handleExpandedChange} value={expanded} type="single">
      ...
      <AccordionItem value="faq-2">
        ...
        <AccordionContent>No. Subtis solamente proporciona subtítulos.</AccordionContent>
      </AccordionItem>
      ...
      <AccordionItem value="faq-6">
        ...
        <AccordionContent>Te recomendamos principalmente la extensión para Stremio.</AccordionContent>
      </AccordionItem>
