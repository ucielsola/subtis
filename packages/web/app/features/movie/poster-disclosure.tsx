  ...
  return (
    <div className="relative w-[384px] h-[611px] overflow-hidden rounded-sm" ref={ref}>
      ...
      <Disclosure
        ...
        open={isOpen}
        className={`absolute bottom-0 left-0 right-0 ${isOpen ? "bg-zinc-950/90" : "bg-zinc-950/50"}  backdrop-blur-md transition-all duration-300 ease-in-out px-2 pt-2 rounded-b-sm`}
