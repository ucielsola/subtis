    ...
    <section className="py-16 flex flex-col gap-32">
      <div className="flex flex-col">
        <div className="flex flex-col gap-4 text-center">
          <h3 className="text-zinc-50 text-3xl font-bold text-balance">Los más buscados</h3>
      ...
      <div className="flex flex-col pt-[514px] pb-72">
        <div className="flex flex-col gap-4 text-center">
          <h3 className="text-zinc-50 text-3xl font-bold text-balance">Últimos estrenos</h3>
