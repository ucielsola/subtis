    ...
    <section className="pb-28 flex flex-col gap-8">
      ...
      <div className="flex flex-col mx-auto items-center gap-2">
        ...
        <div className="flex flex-row gap-2">
          <div className="py-1 px-2 border border-[#232323] rounded-sm uppercase text-zinc-400 text-xs">mp4</div>
          <div className="py-1 px-2 border border-[#232323] rounded-sm uppercase text-zinc-400 text-xs">mkv</div>
          <div className="py-1 px-2 border border-[#232323] rounded-sm uppercase text-zinc-400 text-xs">avi</div>
        </div>
      </div>
    </section>
  );
