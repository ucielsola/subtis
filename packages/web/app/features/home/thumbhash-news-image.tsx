    ...
    <div className="w-[330px] h-[180px]">
      <AspectRatio ratio={11 / 6} className="relative">
        ...
        <img
          ref={imageReference}
          onLoad={onLoaded}
          className={`absolute inset-[2px] brightness-105 ${imgIsLoading ? "opacity-0" : "opacity-100"} transition-all ease-in-out duration-300 w-[326px] h-[176px] rounded-[2px] object-cover`}
          src={src}
          alt={alt}
          loading="lazy"
          decoding="async"
