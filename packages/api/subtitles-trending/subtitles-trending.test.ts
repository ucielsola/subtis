	...
	it("return the last two trending subtitles", async () => {
		...
		expect(data).toEqual([
			...
			},
			{
				...
				resolution: "720p",
				subtitleFullLink:
					"https://yelhsmnvfyyjuamxbobs.supabase.co/storage/v1/object/public/subtitles/no-way-up-720p-yts-mx-subdivx.srt?download=No.Way.Up.2024.720p.WEBRip.x264.AAC-[YTS.MX].srt",
