...
describe('getSubDivXSubtitleLink', () => {
  it('should return an search params for "Guardians of the Galaxy Vol 3 (2023)" for page 1', async ({ expect }) => {
    ...
    expect(subtitleLink).toEqual({
      ...
      subtitleCompressedFileName: 'guardians-of-the-galaxy-vol-3-720p-yts-mx.zip',
      subtitleFileNameWithoutExtension: 'guardians-of-the-galaxy-vol-3-720p-yts-mx',
      fileExtension: 'zip',
    });
  });
});
