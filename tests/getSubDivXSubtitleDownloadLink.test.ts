...
describe("getSubDivXSubtitleDownloadLink", () => {
  it('should return a subtitle page link for "The Guardians of the Galaxy Vol. 3"', async ({
    expect,
  }) => {
    ...
    expect(subDivXSubtitlePageLink).toBe(
      "https://subdivx.com/bajar.php?id=666540&u=9",
    );
  });
});
